   ...
   <div class="col-md-12 offset-md-1"><h2 class="text-white bg-dark"> Order Details</h2></div>
            ...
            <div class="offset-md-2 mt-3 mb-3 col-md-10 ">
                ...
                <div class="row mt-2 mb-2">
                    ...
                    <input type="text" id="ProductName" placeholder="Search for name..">
                </div>
                <div class="row mt-2 mb-2">
                    <div class="col-md-2">
                        <strong>Order Date</strong>
                    </div>
                    <input type="date" class="mr-2" id="OrderDateFrom" placeholder="MM/DD/YYY">
                    <input type="date" id="OrderDateTo" placeholder="MM/DD/YYY">
                </div>
                <div class="row mt-2 mb-2">
                    <div class="col-md-2">
                        <strong>Order Price</strong>
                    </div>
                    <input type="number" class="mr-2" min="1" id="OrderPriceMin" placeholder="">
                    <input type="number" min="1" id="OrderPriceMax" placeholder="">
                </div>
                <div class="row col-md-4">
                    <button type="submit" class="btn mr-2 btn-success searchInfo" id="searchInfo">APPLY</button>
                    <button class="btn mr-2 btn-success">EXPORT</button>
