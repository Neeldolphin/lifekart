<?php  
session_start();  
    require 'Model/loginModel.php';//include loginmodel.php file to access it’s property.  
    ...
    {  
        ...
        {  
            $this->conset = new Config();//make config file object to make connection string.  
