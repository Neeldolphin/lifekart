                    ...
                    <div class="col-md-12 col-sm-6">                    
                        <div id="demo" class="carousel slide" data-interval="false">
                               ...
                               <div class="border p-3">
                                    <img class="img_width xzoom" id="img_max" src="http://localhost/lifekart/Admin/uploads/<?php echo $var[0];?>" xoriginal="http://localhost/lifekart/Admin/uploads/<?php echo $var[0];?>">
                                    </div>
                                    </div>
            ...
            <div class="col-md-12 mt-3">
             ...
             <div class="product-reviews-summary empty">
                ...
                <i class="far fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                    <a class="action add" href="#">Be the first to review this product</a>
                        </div>
                    </div>
                 <?php $cate=new product_details();
                    ...
                    if(in_array($array[3],$rows)){
                     ...
                     <div class="product-info-price">
                        ...
                        <?php }else{?>
                            <div class="product-info-price">
                                 ...
                                 <div class="product attribute overview">
                                    ...
                                    <div class="product-add-form">
                                     <div class="box-tocart">
                                            <div class="fieldset">
                                                    ...
                                                    <input type="number" name="quantity" class="quantity" value="1" min="1" id="quantity" required="">
                                    ...
                                    <div class="product-social-links mt-4"><div class="product-share">
                        ...
                        <div class="col-sm-3 Recent_Products mt-4">
                                <h6 class="sidebartitle">Recent Products</h6>
