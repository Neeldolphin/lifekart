        ...
        <div class="col-md-6">
            ...
            $search=$_GET['name'];
                                ...
                                <div class="page-title-wrapper">
                                    <h1 class="page-title">
                                        <span class="base" data-ui-id="page-title-wrapper">Search results for '<?php echo $search;?>'</span>    </h1>
                                    </div>
                                    <?php           
                                    if($id!=='null'){
                            $rows=$cate->search_post_info($id);
                            foreach($rows as $res){
                                ?>
                        <div class="Blog_Posts mt-0">
                            ...
                            <?php } }else{?>
                                <div class="mt-4 error"><span>There are no related posts yet you searched .</span></div>
                                <?php } ?>
        </div>
